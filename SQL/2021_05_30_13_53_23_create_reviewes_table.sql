CREATE TABLE `reviewes` (
	...
	CONSTRAINT `FK_user` FOREIGN KEY (`uid`) REFERENCES `users` (`id`) ON UPDATE CASCADE ON DELETE CASCADE,
	CONSTRAINT `FK_product` FOREIGN KEY (`pid`) REFERENCES `products` (`id`) ON UPDATE CASCADE ON DELETE CASCADE
);
