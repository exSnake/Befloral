...
<z:layout pageTitle="Product View">
	...
	<form action="Products" method="post">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" name="description" id="description" aria-describedby="descriptionHelp" placeholder="Enter Product Description" required>
			<small id="descriptionHelp" class="form-text text-muted">Enter a description for the product</small>
		</div>

		<div class="form-group">
			<label for="shortDescription">Short Description</label>
			<input type="text" class="form-control" name="shortDescription" id="shortDescription" aria-describedby="shortDescriptionHelp" placeholder="Enter Product Short Description">
			<small id="shortDescriptionHelp" class="form-text text-muted">Enter a short Description</small>
		</div>

		<div class="form-group">
			<label for="metaDescription">Meta Description</label>
			<input type="text" class="form-control" name="metaDescription" id="metaDescription" aria-describedby="metaDescriptionHelp" placeholder="Enter Product meta Description">
			<small id="metaDescriptionHelp" class="form-text text-muted">Enter a meta description</small>
		</div>

		<div class="form-group">
			<label for="metaKeyword">Meta Keyword</label>
			<input type="text" class="form-control" name="metaKeyword" id="metaKeyword" aria-describedby="metaKeywordHelp" placeholder="Enter Product meta keyword">
		...
		<div class="form-group">
			...
			<input type="number" class="form-control" name="weight" id="weight" aria-describedby="weightHelp" step="0.01" placeholder="1,4" required>
		...
		<div class="input-group mb-3">
			...
			<input type="text" class="form-control" aria-label="Amount (in percentage)" name="discount" id="discount" required>
		</div>
		
		<div class="form-group">
			<label for="onSale">Products On Sale</label>
			<input type="number" class="form-control" name="onSale" id="onSale" aria-describedby="onSaleHelp" placeholder="9" required>
			<small id="onSaleHelp" class="form-text text-muted">Enter the number of product on sale</small>
		</div>
		
		<div class="form-group">
			<label for="quantity">Quantity</label>
			<input type="number" class="form-control" name="quantity" id="quantity" aria-describedby="quantityHelp" placeholder="120" required>
