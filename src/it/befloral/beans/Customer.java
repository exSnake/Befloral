...
public class Customer implements Cloneable, Serializable {
      ...
      public void setAll(int idIn, String firstNameIn, String lastNameIn, int genderIn, boolean subscription,
      ...
      public String toString() {
            return "CustomerBean [id=" + id + ", fristname=" + firstName + ", lastname=" + lastName + ", gender="
                        + gender + ", newsletter=" + isSubscripted() + ", birthday=" + birthday + "]";
      }
